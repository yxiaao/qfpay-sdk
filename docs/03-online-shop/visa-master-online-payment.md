...
Payment type | `pay_type` | Yes | String(6) | Please refer to the section [Payment Codes](../preparation/paycode#payment-codes) for a complete list of payment types
...
View page: [DDC_Test.html](@site/static/files/DDC_Test.html)
...
Code reference: [Browser_Redirect_3DS_input.html](@site/static/files/Browser_Redirect_3DS_input.html)
<br/>
