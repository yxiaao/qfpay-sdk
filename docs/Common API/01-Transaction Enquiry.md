...
| Transaction currency | `txcurrcd` | String(3) | View the [Currencies](/docs/In-Store/Payments#currencies) table for a complete list of available currencies |
...
| Payment type | `pay_type` | String(6) | Please refer to the section [Payment Codes](/docs/In-Store/Payments#payment-codes) for a complete list of payment types |
