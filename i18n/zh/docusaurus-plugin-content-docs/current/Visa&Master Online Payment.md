...
We currently support credit card payments in the [Hong Kong environment](#environments). All major credit card issuers are supported.
...
View page: [DDC_Test.html](https://sdk.qfapi.com/files/DDC_Test.html)
...
Code reference: [Browser_Redirect_3DS_input.html](https://sdk.qfapi.com/files/Browser_Redirect_3DS_input.html)
<br/>
